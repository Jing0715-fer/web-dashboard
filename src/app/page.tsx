...
function EnhancedFooter({ projects }: { projects: Project[] }) {
  const [expanded, setExpanded] = React.useState(false)
...
export default function DashboardPage() {
  ...
  const filteredProjects = React.useMemo(() => {
    ...
    return result
  }, [projects, searchQuery, filterStatus, filterTags, sortBy, starredIds])
  ...
  const activeFilters = React.useMemo(() => {
    ...
    return filters
  }, [filterStatus, filterTags, searchQuery])
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* ======================== FOOTER ======================== */}
      <EnhancedFooter projects={projects} />
